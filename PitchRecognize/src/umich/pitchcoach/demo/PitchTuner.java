...
public class PitchTuner extends View { // TODO: implements pitch listener?
	...
	private static final int centerDegree = 0; // the one in the top center (12
												// o'clock)
	 ...
	 * super.onAttachedToWindow(); attachToSensor(); }
	 * 
	 * @Override protected void onDetachedFromWindow() { detachFromSensor();
	...
	/*
	 * private SensorManager getSensorManager() { return (SensorManager)
	 * getContext().getSystemService(Context.SENSOR_SERVICE); }
	 * 
	 * private void attachToSensor() { SensorManager sensorManager =
	 * getSensorManager();
	 * 
	 * List<Sensor> sensors =
	 * sensorManager.getSensorList(Sensor.TYPE_TEMPERATURE); if (sensors.size()
	 * > 0) { Sensor sensor = sensors.get(0);
	 * sensorManager.registerListener(this, sensor,
	 * SensorManager.SENSOR_DELAY_FASTEST, handler); } else { Log.e(TAG,
	 * "No temperature sensor found"); } }
	 * 
	 * private void detachFromSensor() { SensorManager sensorManager =
	 * getSensorManager(); sensorManager.unregisterListener(this); }
	 */
	 ...
	 * }
	 * 
	 * @Override public void onSensorChanged(SensorEvent sensorEvent) { if
	 * (sensorEvent.values.length > 0) { float temperatureC =
	 * sensorEvent.values[0]; //Log.i(TAG, "*** Temperature: " + temperatureC);
	 * 
	 * float temperatureF = (9.0f / 5.0f) * temperatureC + 32.0f;
	 * setHandTarget(temperatureF); } else { Log.w(TAG,
	 * "Empty sensor event received"); } }
	 */
