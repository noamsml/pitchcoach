...
public class GraphContainer extends SizableElement implements
		IImageSourceSource {
	 ...
	 * 
	 * 
	 * public Bundle saveState() { Bundle b = new Bundle();
	 * b.putDouble("target", targetFreq); return b; }
	 */
	...
	public void makeDone() {
		...
		EventStream.submitEventPerformance(targetPitch, currentEvent,
				(long) evalVal);
	}
