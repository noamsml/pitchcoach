...
public class PitchThread extends Thread {
	...
	public void run() {
		audioRec = new AudioRecord(MediaRecorder.AudioSource.VOICE_RECOGNITION,
				Invariants.RATE, AudioFormat.CHANNEL_IN_MONO,
				AudioFormat.ENCODING_PCM_16BIT,
				4 * AudioRecord.getMinBufferSize(Invariants.RATE,
	...
	public void handleAudioData() {
		...
		if (pitch != -1)
			onPitch(pitch, getTimeDuration(size));
